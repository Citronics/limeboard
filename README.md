...
- **datasheet.md**  
  Technical specifications of the Limeboard hardware.

- **hardware-validation.md**  
  Defines the hardware validation scope used to confirm basic operability prior to shipment.

- **known-issues-and-limitations.md**  
  Lists known issues, functional limitations, and handling warnings applicable to the current reference configuration.
...
The applicable version is the one published at the time of product delivery.
